...
export default class RosterScene extends Phaser.Scene {
  ...
  _showList() {
    ...
    c.add(addPanelImage(this, W / 2, 40, 'panelSmall', { displayWidth: 210, displayHeight: 42, alpha: 0.76 }));
  ...
  _drawCard(hero, y, c) {
    ...
    c.add(addPanelImage(this, W / 2, y, 'cardFrameGold', { displayWidth: 446, displayHeight: 80, alpha: 0.86 }));
    const bg = this.add.rectangle(W / 2, y, 446, 80,
      ...
      .on('pointerout',  () => bg.setAlpha(0.58))
      .on('pointerup',   () => { bg.setAlpha(0.58); this._showDetail(hero); });
    c.add(bg);
  ...
  _showDetail(hero) {
    ...
    // Stats panel
    c.add(addPanelImage(this, W / 2, 258, 'panelLarge', { displayWidth: 438, displayHeight: 100, alpha: 0.85 }));
    c.add(this.add.rectangle(W / 2, 258, 438, 100, 0x111130).setStrokeStyle(1, 0x2a2a55).setAlpha(0.5));
    ...
    // Level / XP panel
    c.add(addPanelImage(this, W / 2, 368, 'panelSmall', { displayWidth: 438, displayHeight: 84, alpha: 0.82 }));
    c.add(this.add.rectangle(W / 2, 368, 438, 84, 0x111130).setStrokeStyle(1, 0x2a2a55).setAlpha(0.52));
    ...
    ['WEAPON', 'ROBE', 'ACCESSORY', 'RELIC', 'SIGIL'].forEach((slot, i) => {
      const x = 50 + i * 96;
      c.add(addPanelImage(this, x, 558, 'panelSmall', { displayWidth: 84, displayHeight: 64, alpha: 0.78 }));
      c.add(this.add.rectangle(x, 558, 84, 64, 0x111130).setStrokeStyle(1, 0x2a2a55).setAlpha(0.5));
  ...
  _addLevelUpBtn(hero, c, W) {
    ...
    c.add(addUIButton(this, W / 2, 448, active ? 'buttonPrimary' : 'buttonSecondary', { displayWidth: 360, displayHeight: 54, alpha: 0.86 }));
    c.add(btn);
